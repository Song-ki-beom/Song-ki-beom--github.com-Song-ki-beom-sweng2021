...
def printScreen(board):
        ...
        colorarray = board.oScreenColor.get_array()
        for y in range(board.oScreen.get_dy()- Ctetris.iScreenDw):
                ...
                for x in range( Ctetris.iScreenDw, board.oScreen.get_dx()- Ctetris.iScreenDw):
                    if array[y][x] == 0:
                        ...
                        if colorarray[y][x] == 1:
                            print( "\033[31m" + '■',end="")
                        elif colorarray[y][x] == 2:
                            print( "\033[32m" + '■',end="") 
                        elif colorarray[y][x] == 3:
                            print( "\033[33m" + '■',end="") 
                        elif colorarray[y][x] == 4:
                            print( "\033[34m" + '■',end="") 
                        elif colorarray[y][x] == 5:
                            print( "\033[35m" + '■',end="") 
                        elif colorarray[y][x] == 6:
                            print( "\033[36m" + '■',end="") 
                        elif colorarray[y][x] == 7:
                            print( "\033[95m" + '■',end="") 
                        else:
                            print( "\033[30m" + '■',end="")
                    else:
